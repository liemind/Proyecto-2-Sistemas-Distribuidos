...
public class FXMLDocumentController implements Initializable
{
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
        ...
        ArrayList<Combustible> cc = Procesos.ObtenerCombustibles();
        int size = cc.size()-1;
    ...
    public void obtenerInforme() {
        ...
        if(!opcion.isEmpty()) {
            if(opcion.equals("Transacciones anuales por sucursal")) {
                arr = Procesos.ObtenerTransaccionesAnualesPorSucursal();
                fechaH1.setText("Año");
                ...
                arr = Procesos.filtrarPorMesYAño();
    ...
    public void cambiarNumero()
    {
        ...
        fecha_hora=Procesos.ObtenerFechaYHoraActual();
        if (!n3.isEmpty())
        {
        ...
        {
            String mensaje = "";
            conn = Procesos.conectar("empresa.db");
